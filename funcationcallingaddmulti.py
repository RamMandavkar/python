...
## 2. Defined a real function: add, multiply
...
multiply_decl = types.FunctionDeclaration(
    name="multiply",
...
tools = [types.Tool(function_declarations=[add_decl, multiply_decl])]
config = types.GenerateContentConfig(tools=tools)

## 5. Took the User Prompt
prompt="What is 3 + 4 and execute 6 * 2 "
